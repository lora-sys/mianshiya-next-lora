package com.lora.mianshihou.generate;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        // 指定生成参数
        String packageName = "com.lora.mianshihou";
        String dataName = "题库题目";
        String dataKey = "questionBank_question";
        String upperDataKey = "QuestionBank_Question";
